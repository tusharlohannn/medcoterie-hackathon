...
function Header({ isLoggedIn }) {
  ...
  async function markAllAsRead() {
    const userId = localStorage.getItem("user_id");
    try {
      await axios.put(`${baseUrl}/api/notifications/read/${userId}`);
